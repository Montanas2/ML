...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/luqMxD8WYk)
...
```sh
npx nx serve montana
```

To create a production bundle:

```sh
npx nx build montana
```

To see all available targets to run for a project, run:

```sh
npx nx show project montana
```
